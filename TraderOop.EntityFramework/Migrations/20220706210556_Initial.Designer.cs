...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TraderOop.Domain.Models.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TraderOop.Domain.Models.AssetTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TraderOop.Domain.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TraderOop.Domain.Models.Account", b =>
                {
                    b.HasOne("TraderOop.Domain.Models.User", "AccountHolder")
                        .WithMany()
            ...
            modelBuilder.Entity("TraderOop.Domain.Models.AssetTransaction", b =>
                {
                    b.HasOne("TraderOop.Domain.Models.Account", "Account")
                        .WithMany("AssetTransactions")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("TraderOop.Domain.Models.Stock", "Stock", b1 =>
                        {
